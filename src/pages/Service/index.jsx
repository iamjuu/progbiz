...
const Services = () => {
  ...
  const services = [
    { imgSrc: About1, title: "Window Air Conditioning", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", btnName: "Know More" },
    { imgSrc: About3, title: "Air Conditioning Service", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", btnName: "Know More" },
    { imgSrc: About4, title: "Heating Systems", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", btnName: "Know More" },
    { imgSrc: About5, title: "Ventilation Systems", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", btnName: "Know More" },
    { imgSrc: About6, title: "Energy Efficiency Consulting", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", btnName: "Know More" },
  ];
  ...
  <div key={index} data-aos="fade-up" className="flex flex-wrap gap-5 mb-10 sm:flex-nowrap">
    <img
