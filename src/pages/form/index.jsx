...
const CoolingUpgradeForm = () => {
  ...
  return (
    <div  
    style={{
      backgroundImage: `url(${Form})`  // Corrected the background image syntax
    }} 
  ...
  >
    ...
    >
      ...
      <h1 className="text-white text-4xl lg:text-6xl">Ready to Upgrade Your Cooling?</h1>
      <p className="text-white text-base">Tellus rutrum tellus pellentesque eu. Sagittis purus sit amet volutpat. Sed ullamcorper tellus rutrum tellus pellentesque eu. Sagittis purus sit</p>
